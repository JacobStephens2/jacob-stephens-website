...
<head>
  ...
  <style data-href="/styles.7f8454cecc159920581f.css" data-identity="gatsby-global-css">
    @charset "UTF-8";
    ...
    .mainNav-module--mainnav--3r8uo {
      font-family: Arial, Helvetica, sans-serif;
      margin: 0 auto
    }

    .mainNav-module--mainnav--3r8uo ul {
      flex-wrap: wrap;
      margin: 0;
      padding: 0
    }

    .mainNav-module--mainnav--3r8uo ul ul {
      flex-direction: column
    }

    .mainNav-module--mainnav--3r8uo li {
      list-style-type: none
    }

    .mainNav-module--mainnav--3r8uo a {
      border: 1px solid hsla(0, 0%, 100%, 0);
      color: var(--cream);
      display: block
    }

    .mainNav-module--mainnav--3r8uo a:focus,
    .mainNav-module--mainnav--3r8uo a:hover {
    ...
    .footer-module--footer--2-hg1 {
      background-color: var(--dark-green);
      border-top: 1rem solid var(--cream);
      color: var(--cream);
      display: flex;
    ...
    *,
    ...
    .single-module--article__meta--2B_eP,
    .single-module--article__tax--JP9-I {
      font-family: var(--highlight-font);
      font-size: 80%
    }

    .single-module--article--1iUKO {
      margin: 0 auto;
      max-width: var(--content-w-narrow);
      padding: 0 0 1rem
    }

    .single-module--featimg--94Ix- {
      margin-left: -2rem;
      margin-right: -2rem;
      margin-top: 3rem
    }

    .single-module--homeSection--1gnDK {
      max-width: var(--content-w-narrow)
    }

    .single-module--article__title--1m8hL {
      font-size: 2rem;
      margin-bottom: 1rem;
      padding-top: 10px;
      text-align: left
    ...
    .single-module--article__content--7dEpL {
      margin: 1.5rem auto 0;
      max-width: var(--content-w-narrow)
    }

    .single-module--articlelist--2cPUw {
      margin: 0;
      max-width: var(--content-w-narrow);
      padding: 0
    }

    .single-module--articlelist--2cPUw h2 {
      font-size: 1.5rem;
      padding: 0;
      text-align: left
    }

    .single-module--articlelist--2cPUw ul {
      margin: 0;
      padding: 0 1rem
    }
    ...
    .single-module--listitem--29tzQ .single-module--article__content--7dEpL {
      margin: 1rem 0 0
    }

    .single-module--listitem--29tzQ:after {
    ...
    .single-module--container--zCgXc {
      color: var(--cream);
      position: relative;
      text-align: center
    }

    .single-module--dark__overlay--1hqEu {
      filter: brightness(50%)
    }

    .single-module--hero__container--JBbLh {
      height: 667px;
      position: relative
    }

    .single-module--video--2QPCm {
      height: 584px;
      left: 0;
      -o-object-fit: cover;
      object-fit: cover;
    ...
    .single-module--hero__text--DQpDG {
      align-items: center;
      bottom: 0;
      color: var(--cream);
      display: flex;
    ...
    .single-module--crestContainer--yFUjS {
      align-items: center;
      display: flex;
      height: 300px;
      justify-content: center;
    ...
    .single-module--container__top--NT6KQ {
      color: var(--cream);
      padding-top: 6px;
      position: relative;
      text-align: center
    ...
    .single-module--center__text--2mS43 {
      text-align: center
    }

    .single-module--belowheader--1kv9l {
      padding-top: 84px
    }

    .single-module--crestcontainer--3hLdg {
      margin-left: auto;
      margin-right: auto;
      position: absolute;
      top: 100px;
    ...
    .catlist-module--article__catlist--3hS28 {
      padding-bottom: 10px;
      text-align: left
    }

    .catlist-module--article--12zso .catlist-module--article__catlist--3hS28 {
      padding-top: 1rem
    }

    .catlist-module--catName--1n_lg {
      display: inline
    }

    .postNav-module--postnav--3mDDd {
      grid-gap: 1rem;
      gap: 1rem;
      display: flex;
      justify-content: center;
    ...
    .postNav-module--postnav--3mDDd a {
    ...
    .postNav-module--postnav--3mDDd a:first-of-type {
      text-align: right
    }

    .postNav-module--postnav__head--301EZ {
      font-size: 80%
    }

    .postNav-module--postnav__title--1_gx8 {
      font-size: 110%;
      font-weight: 700;
      text-decoration: underline
    }
  </style>
  <link rel="stylesheet" href="/styles/post_index_styles.css">
  <meta name="generator" content="Gatsby 3.7.2" />
  <style data-styled="" data-styled-version="5.3.0"></style>
  <title data-react-helmet="true">Posts | Jacob Stephens&#x27; Personal Site</title>
  <meta data-react-helmet="true" name="description" content="A web designing board game player" />
  <meta data-react-helmet="true" property="og:title" content="Posts" />
  ...
  <meta data-react-helmet="true" name="twitter:title" content="Posts" />
  ...
  <link as="script" rel="preload" href="/component---src-templates-page-js-a65d3ebc49f2f81ea6e4.js" />
  <link as="fetch" rel="preload" href="/page-data/posts/page-data.json" crossorigin="anonymous" />
...
<body>
                  ...
                  <div class="bm-menu" style="height:100%;box-sizing:border-box;overflow:auto">
                    <nav class="bm-item-list" style="height:100%">
                      <ul>
                        ...
                        <li><a aria-current="page" class="current-page" href="/posts/">Posts</a></li>
                      </ul>
                    </nav>
                  </div>
                  <div>
          ...
          <article class="single-module--article--1iUKO">
            ...
            <div>
              <ul class="wp-block-latest-posts__list has-dates wp-block-latest-posts">
                ...
                <li>
                    <a href="/posts/bending_fire/">
                      Bending Fire
                    </a>
                    <div>
                      <time datetime="2024-10-10T22:13:18+00:00"
                        class="wp-block-latest-posts__post-date inline"
                        >
                        October 10, 2024
                      </time>
                      &ensp;
                      <span class="category">Short Story</span>
                    </div>
                </li>

                <li>
                  <a href="/posts/why-anti-cyrillic-croats-attack-serbian-language/">
                ...
                <li>
                    <a href="/posts/two-natures-one-being/">
                      Two Natures, One Being: An Evaluation of Bonhoeffer on the Person of Christ
                    </a>
                    <div>
                      <time datetime="2024-10-10T22:13:18+00:00"
                        class="wp-block-latest-posts__post-date inline"
                      ...
                      &ensp;
                      <span class="category">Research Paper</span>
                    </div>
                </li>
  ...
  <script id="gatsby-script-loader">/*<![CDATA[*/window.pagePath = "/posts/";/*]]>*/</script>
  <script
  ...
  <script src="/component---src-templates-page-js-a65d3ebc49f2f81ea6e4.js" async=""></script>
